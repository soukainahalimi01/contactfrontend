  ...
  return (
    <div style={{ padding: "25px" }}>
      ...
      <div style={{
        ...
        <h2 style={{ margin: 0, fontSize: "18px", fontWeight: "500", color: "white" }}>
          Users
        </h2>
      </div>

      {/* Search — katban GHIR l admin */}
      {isAdmin && (
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          ...
          <tbody>
            {filteredUsers.length === 0 ? (
              ...
              filteredUsers.map((u) => (
                <tr key={u.id}
                  style={{ borderBottom: "1px solid #f0f0f0", background: "#ffffff", transition: "0.2s" }}
